...
export class NamingStrategy extends DefaultNamingStrategy {
  ...
  joinTableName (firstTableName: string, _secondTableName: string, firstPropertyName: string) {
    return snakeCase(`${pluralize.singular(firstTableName)}_${firstPropertyName}`)
  }
